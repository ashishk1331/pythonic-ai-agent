...
class ConfigManager():
    def __init__(self):
        ...
        self.TINYFISH_SEARCH_URL = OS.getenv("TINYFISH_SEARCH_URL", "https://api.search.tinyfish.ai")
        self.TINYFISH_FETCH_URL = OS.getenv("TINYFISH_FETCH_URL", "https://api.fetch.tinyfish.ai")
        ...
        self.ALTERNATE_MODEL_NAME = OS.getenv("ALTERNATE_MODEL_NAME", "moonshotai/kimi-k2.6:free")
        self.AUXILIARY_MODEL_NAME = OS.getenv("AUXILIARY_MODEL_NAME", "liquid/lfm-2.5-1.2b-thinking:free")
